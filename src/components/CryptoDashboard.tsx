  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const balcoin = {
        ...
        id: "bapple",
        image:
          "https://api.skillerszone.com//photos/blog/images/dall_e_2024-11-19_19.51.36_-_a_circular_cryptocurrency_logo_for__bapple___resembling_bitcoin_with_a_gold_background__featuring_the_letter__b__in_bold_white_at_the_center._an_apple-removebg-preview-1732024402002.png",
        ...
        roi: null,
        sparkline_in_7d: { price: [0.48, 0.86, 1.67, 1.26, 2.59, 0.9, 1.01] },
        symbol: "bap",
  ...
  return (
    ...
    >
      <Header className="flex  justify-between items-center bg-transparent">
        <div className=" w-full flex gap-5 max-lg:gap-0 max-lg:flex-col justify-center items-center max-lg:mt-10">
          <h1
      ...
      <Content className="p-8">
        ...
        <Card className={`mb-8 ${isDarkMode ? "bg-gray-800 text-white" : ""}`}>
          <div className="mb-4 flex max-lg:flex-col max-lg:gap-3 justify-between items-center">
            <Input
